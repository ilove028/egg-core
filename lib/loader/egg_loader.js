...
class EggLoader {
  ...
  requireFile(filepath) {
    ...
    const ret = utils.loadFile(filepath); // just like node require when file is js json node other just read file content 
